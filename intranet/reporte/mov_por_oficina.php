...
<td>
	<div class="input-prepend input-append">			
		<table>	
			<tr height="45">		
				<td colspan="3" bgcolor="#ECEEF1" class="form-subtitle">&nbsp;&nbsp;Movimiento por Oficina</td>									
			</tr>
			<tr>		
				<td colspan="3" >&nbsp;</td>									
			</tr>			
...
function buscar_examen(){
	...
	load_div("subcontenido","reporte/mov_por_oficina/buscar2_click.php?n="+examen+"&s="+seccion);
}
</script>